...
def DDA(a, b):
    ...
    for i in range (s, steps +1):
        ...
        plt.plot(round(f), round(ff), marker="s", color="black")
        plt.plot(round(y1), round(gg), marker="s", color="black")
...
def BRESENHAMS(a, b):
    ...
    while x1 < x2:
        plt.plot(round(x1),round(y1), marker="s", color="black")
        plt.plot(round(x2),round(y2), marker="s", color="black")
        plt.plot(round(y2),round(x2), marker="s", color="black")
        plt.plot(round(y1),round(x1), marker="s", color="black")
        x1= x1 + 1
